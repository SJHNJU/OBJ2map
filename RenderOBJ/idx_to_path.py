...
def idx_to_path(pidx, eidx):
    ...
    model_path = root+'/'+str(pidx)+'_OK_OK'+'/'+expression_name[eidx-1]+'_crop.obj'

    img_save_dir = save_root+'/'+str(pidx)+'_OK_OK'

    img_save_path = img_save_dir+'/'+expression_name[eidx-1]+'.png'

    return model_path, img_save_dir, img_save_path
